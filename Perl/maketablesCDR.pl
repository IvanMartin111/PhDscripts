...
my $fout="CDRsumary_map_OCB.csv";

my $H1_rcd="20K_H1_map_rep";
my $H2_rcd="20K_H2_map_rep";
my $H3_rcd="50K_H3_map_rep";
my $L1_rcd="20K_L1_map_rep";
my $L2_rcd="20K_L2_map_rep";
my $L3_rcd="20K_L3_map_rep";


$rosnam{H1}="_native_20K_H1_map_rep";  #rosettaX  _native_1K_H1_map_rep  X.txt
$rosnam{H2}="_native_20K_H2_map_rep";  
$rosnam{H3}="_native_50K_H3_map_rep";  
$rosnam{L1}="_native_20K_L1_map_rep"; 
$rosnam{L2}="_native_20K_L2_map_rep";  
$rosnam{L3}="_native_20K_L3_map_rep"; 
